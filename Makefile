...
BARVINOK_INC=-I/home/users/kewen/software/barvinok-0.39_build/include
BARVINOK_LIB=/home/users/kewen/software/barvinok-0.39_build/lib
LIBGMP=/home/users/kewen/software/gmp-6.1.1_build/lib
HOME_INC=-I.
...
LIBS = -Wl,-rpath,$(ROSE_HOME)/lib -L$(ROSE_HOME)/lib -lrose \
	...
	-Wl,-rpath,$(LIBGMP) -L$(LIBGMP) -lgmp \
	-Wl,-rpath,$(BARVINOK_LIB) -L$(BARVINOK_LIB) -lisl -lbarvinok

# Default make rule to use
all: $(PROGRAM)

%.o : %.C
	$(CXX) -c $(CXXFLAGS) $(DEFINES) $(BOOST_INC) $(ROSE_INC) $(BARVINOK_INC) $(HOME_INC) $<
